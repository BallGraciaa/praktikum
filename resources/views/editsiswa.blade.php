            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-10">
                            <input type="teks" class="form-control" name="nama" value="{{$datasiswa->nama}}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="" class="col-form-label col-2">Alamat</label>
                        <div class="col-10">
                            <input type="teks" class="form-control" name="alamat" value="{{$datasiswa->alamat}}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="" class="col-form-label col-2">No Telpon</label>
                        <div class="col-10">
                            <input type="teks" class="form-control" name="no_telp" value="{{$datasiswa->no_telp}}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="" class="col-form-label col-2">Kode Kelas</label>
                        <div class="col-10">
                            <input type="teks" class="form-control" name="kode_kelas" value="{{$datasiswa->kode_kelas}}">
                        </div>
                    </div>
                    <div class="mb-3">
